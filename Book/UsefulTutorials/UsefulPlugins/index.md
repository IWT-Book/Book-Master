...
## Miscellaneous Plugins need to be test it
1. 
...
9. 
    ...
    * Name: Interactive exercises in a gitbook (**_Test it on 07/22/2018 and its not good for HTML tags_**)
...
1. 
    ...
    * Name: Embed bilibili videos in gitbook (**_On hold because its only support www.bilibili.com 7/22/2018_**)
...
2. 
    ...
    * Name: Gitbook Plugin - Google Drive Video (**_Working 100% testing on 7/22/2018_**)
...
3. 
    ...
    * Name: Gitbook plugin iframely (**_Need to be test it_**)
...
4. 
    ...
    * Name: modal-youtube-video (**_Need to be test it_**)
...
5. 
    ...
    * Name: Gitbook Plugin for Video.js (**_Need to be test it_**)
...
6. 
    ...
    * Name: Gitbook plugin Noembed (**_Need to be test it_**)
...
1. 
    ...
    * Name:  get-pdf-link (**_Need to be test it_**)
    * Description: N/A
...
2. 
    ...
    * Name: gitbook-plugin-downloadpdf (**_Need to be test it_**)
...
3. 
    ...
    * Name: Post-processing your GitBook PDFs made easy (**_Need to be test it_**)
...
4. 
    ...
    * Name: Gitbook plugin download-pdf-link (**_Need to be test it_**)
...
5. 
    ...
    * Name: Gitbook plugin get-book (**_Need to be test it_**)
    * Description: GitBook Plugin to add a link on every page to download PDF.
...
6. 
    ...
    * Name: gitbook-plugin-canonical-link (**_Need to be test it_**)
    * Description: N/A
...
1. 
    ...
    * Name: Inline discussions with gitbook.com (**_Need to be test it_**)
...
2. 
    ...
    * Name: facebook (**_Need to be test it_**)
...
3. 
    ...
    * Name: gitbook-comment (**_Need to be test it_**)
...
4. 
    ...
    * Name: Marginal (**_Need to be test it_**)
...
5. 
    ...
    * Name:  richquotes (**_Need to be test it_**)
...
6. 
    ...
    * Name: Transform comments to notes (**_Need to be test it_**)
